...
namespace IPGManager.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(IPGManagerDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("HorarioId,HInicio,HInicioIntervalo,HFimIntervalo,HFim")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HorarioId,HInicio,HInicioIntervalo,HFimIntervalo,HFim")] Horario horario)
        {
